[![npm stat](https://img.shields.io/npm/dm/@bottom-sheet/state-machine.svg?style=flat-square)](https://npm-stat.com/charts.html?package=@bottom-sheet/state-machine)
